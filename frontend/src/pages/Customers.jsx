...
export default function Customers() {
  ...
  const load = async () => { const r = await api.get('/customers'); setList(r.data); };
    ...
    <div>
      ...
      <div className="px-5 py-4">
        <div className="flex items-center gap-2 border border-gray-200 rounded-md px-2.5 py-1.5 bg-white mb-3 w-full sm:w-fit">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search name, phone, email…" className="text-[12px] focus:outline-none flex-1 sm:w-52" />
